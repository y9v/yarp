...
YP_IMPORTED_FUNCTION extern yp_buffer_t * yp_buffer_alloc(void);

// Initialize a yp_buffer_t with its default values.
YP_IMPORTED_FUNCTION extern void yp_buffer_init(yp_buffer_t *buffer);
...
YP_IMPORTED_FUNCTION extern void yp_buffer_free(yp_buffer_t *buffer);
