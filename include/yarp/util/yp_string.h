...
YP_IMPORTED_FUNCTION extern size_t yp_string_length(const yp_string_t *string);

// Returns the start pointer associated with the string.
YP_IMPORTED_FUNCTION extern const char * yp_string_source(const yp_string_t *string);

// Free the associated memory of the given string.
YP_IMPORTED_FUNCTION extern void yp_string_free(yp_string_t *string);
