...
YP_IMPORTED_FUNCTION extern void yp_string_list_init(yp_string_list_t *string_list);
...
YP_IMPORTED_FUNCTION extern void yp_string_list_free(yp_string_list_t *string_list);
